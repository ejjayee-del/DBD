    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('secretary', 'Secretary - View & Print'), ('officer', 'Officer - View, Print & Edit'), ('admin', 'Admin - Full Access (View, Print, Edit, Delete)')], default='secretary', max_length=20)),
